...
public class SwerveModule extends Subsystem {
    ...
    public SwerveModule(SwerveModuleConstants constants) {
        ...
        TalonUtil.checkError(mAzimuthTalon.config_kP(0, mConstants.kAzimuthKp, Constants.kLongCANTimeoutMs),
                "Error in " + mConstants.kName + "Module: Unable to config azimuth kp");
        TalonUtil.checkError(mAzimuthTalon.config_kI(0, mConstants.kAzimuthKi, Constants.kLongCANTimeoutMs),
        ...
        TalonUtil.checkError(mAzimuthTalon.config_kD(0, mConstants.kAzimuthKd, Constants.kLongCANTimeoutMs),
                "Error in " + mConstants.kName + "Module: Unable to config azimuth kd");
        TalonUtil.checkError(mAzimuthTalon.config_kF(0, mConstants.kAzimuthKf, Constants.kLongCANTimeoutMs),
        ...
        TalonUtil.checkError(mAzimuthTalon.configForwardSoftLimitEnable(false, Constants.kLongCANTimeoutMs),
                "Error in " + mConstants.kName + "Module: Unable to disable azimuth forward soft limit");
        TalonUtil.checkError(mAzimuthTalon.configReverseSoftLimitEnable(false, Constants.kLongCANTimeoutMs),
